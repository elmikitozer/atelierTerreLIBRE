...
export default async function TeamBuildingSection() {
  ...
  return (
    <section id="team-building" className="px-5 md:px-12 py-12 md:py-16 bg-ink border-b border-yellow/10">
      ...
      <Reveal>
        ...
        >
          ...
          <RevealList className="flex flex-col gap-2">
            {OBJECTIFS.map((obj, i) => (
              <RevealItem key={i} className="border-b border-yellow/10 pb-2">
      ...
      {/* Mention tarif + CTA */}
      <Reveal className="mt-10 border-t border-yellow/10 pt-8 md:flex md:items-center md:justify-between md:gap-10">
